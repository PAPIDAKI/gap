...
class ProceduresControllerTest < ActionController::TestCase
  ...
  test "should create procedure" do
    assert_difference('Procedure.count') do
      post :create, procedure: { accountable: @procedure.accountable, clitem_id: @procedure.clitem_id, result: @procedure.result, title: @procedure.title }
    end
  ...
  test "should update procedure" do
    patch :update, id: @procedure, procedure: { accountable: @procedure.accountable, clitem_id: @procedure.clitem_id, result: @procedure.result, title: @procedure.title }
    assert_redirected_to procedure_path(assigns(:procedure))
  end
